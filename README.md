# VIBRATO: Cross-Embodiment Visual Imitation for Whole-Body Manipulation using a Wearable Gripper
...
LEGATO is released under the [MIT License](LICENSE). The `flex_ik` part of this code was produced as part of Mingyo Seo's internship at the Boston Dynamics AI Institute in 2023 and 2024 and is provided "as is" without active maintenance. For questions, please contact [Mingyo Seo](https://mingyoseo.com) or [H. Andy Park](https://www.linkedin.com/in/robodreamer/).
